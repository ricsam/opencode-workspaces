...
func TestWorkspacePodSecurity(t *testing.T) {
	c := &Controller{Client: fake.NewSimpleClientset(), Config: config.Config{Workspace: config.Workspace{Image: "workspace:test", ImagePullPolicy: "IfNotPresent", CPURequest: "100m", MemoryRequest: "128Mi", CPULimit: "1", MemoryLimit: "1Gi", Port: 4096}}}
